...
export type ParamsOfGetAccount = {
...
export class AccountModule {
     ...
     */
    get_account(params: ParamsOfGetAccount): Promise<ResultOfGetAccount> {
     ...
     * @returns ResultOfGetAccount
     */
    get_account_sync(params: ParamsOfGetAccount): ResultOfGetAccount {
