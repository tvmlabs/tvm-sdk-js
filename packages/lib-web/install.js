...
async function main() {
    ...
    await dl(path.join(binariesTargetPath, `index.js`), `tvmsdk_${binariesVersion}_wasm_js`);
    await dl(path.join(binariesTargetPath, `tvmsdk.wasm`), `tvmsdk_${binariesVersion}_wasm`);
}
